...
public class ImageTool {
    ...
    public static void main(String[] args) throws IOException {
    	...
    	imageTool.setImage(ImageIO.read(new File("a.jpg")));
    	
    	imageTool.changeToGrayImage();
//    	imageTool.changeToBlackWhiteImage();
    	imageTool.removeBadBlock(100,100,100);
    	imageTool.midddleValueFilter(1, true);
//    	imageTool.modifyBlank(2);
    	
    	imageTool.saveToFile("temp.jpg");
	}
